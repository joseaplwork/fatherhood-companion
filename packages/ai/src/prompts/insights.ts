...
export function buildInsightsPrompt(ctx: InsightsContext): string {
  ...
  return `Based on the following mood data for a single father over the past week, generate a single brief (1-2 sentence), warm, and encouraging insight or observation. Focus on patterns, progress, or gentle acknowledgment. Do not be clinical or list-like — speak directly to him.
